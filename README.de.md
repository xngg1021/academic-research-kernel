...
CI führt die vollständige QA-Suite per GitHub Actions auf Linux x86_64 (Python 3.10-3.14), Linux ARM64 (ubuntu-24.04-arm), Ubuntu 26.04 Preview-Canary (ubuntu-26.04 und ubuntu-26.04-arm), Windows x86_64, Windows ARM64 (windows-11-arm), macOS ARM64 (macos-latest) und macOS Intel (macos-15-intel) über alle Plattformen und Architekturen aus, mit 654 bestandenen Unit-Tests und kontinuierlicher Upstream-Canary-Validierung. Ein separater Tap-Integrations-Workflow läuft bei Push auf main: Er installiert den gepinnten Hermes-Checkout aus tests/upstream/provenance.json und führt tap add, search, install und list gegen dieses Repository aus. Exakte Versionen, Prüfungen und Einschränkungen stehen im [Audit](docs/audit-20260906.md).
