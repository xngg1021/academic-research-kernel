...
| `skills/research-object-identity` | 1.1.0 | Capa de identidad determinista de objetos de investigación: normalización de identificadores, veredicto de cinco estados (sin puntuaciones de confianza), aristas de relación y linaje; consume recibos de evidencia |
