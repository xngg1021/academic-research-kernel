...
| `skills/decision-ledger` | 1.0.0 | Registro determinista de solo anexado de decisiones de investigación, resultados negativos, causalidad de poda y correcciones de resultados |
