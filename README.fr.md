...
| `skills/research-object-identity` | 1.1.0 | Couche d'identité déterministe des objets de recherche : normalisation des identifiants, verdict à cinq états (sans score de confiance), arêtes de relation et de lignage ; consomme les reçus de preuve |
