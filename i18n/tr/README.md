...
CI; Linux x86_64 (Python 3.10-3.14), Linux ARM64, Ubuntu 26.04 Preview, Windows x86_64, Windows ARM64, macOS ARM64 ve macOS Intel genelinde tam QA paketini çalıştırır. 696 birim testi geçer ve 40 çalıştırılabilir kod bloğu doğrulanır.
