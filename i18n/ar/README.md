...
يقوم CI بتشغيل مجموعة الاختبارات الكاملة عبر Linux x86_64 (Python 3.10-3.14) و Linux ARM64 و Ubuntu 26.04 Preview و Windows x86_64 و Windows ARM64 و macOS ARM64 و macOS Intel، مع نجاح 696 اختبار وحدة والتحقق من 40 كتلة كود قابلة للتنفيذ.
