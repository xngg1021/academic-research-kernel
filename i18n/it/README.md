...
La CI esegue la suite completa di test su Linux x86_64 (Python 3.10-3.14), Linux ARM64, Ubuntu 26.04 Preview, Windows x86_64, Windows ARM64, macOS ARM64 e macOS Intel, con 696 test unitari superati e 40 blocchi di codice eseguibili validati.
