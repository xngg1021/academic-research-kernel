...
O CI executa a suíte completa de testes no Linux x86_64 (Python 3.10-3.14), Linux ARM64, Ubuntu 26.04 Preview, Windows x86_64, Windows ARM64, macOS ARM64 e macOS Intel, com 691 testes unitários aprovados e 40 blocos de código executáveis validados.
